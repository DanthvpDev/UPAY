...
INSERT INTO GRADOS_ACADEMICOS (GRADO, PUNTOS, CATEGORIA)
VALUES
('CERT', 1, 1),
('BACH', 2, 1),
('LICI', 3, 2),
...
VALUES 
(GETDATE() + 4, NULL, 'ACT', 0, '204589123', 4),
(GETDATE() + 2, NULL, 'ACT', 0, '108965478', 2),
(GETDATE() + 1, NULL, 'ACT', 1, '101230456', 1),
(GETDATE() + 5, NULL, 'ACT', 1, '302154789', 1);

select * from CARRERA_PROFESIONAL cp inner join GRADOS_ACADEMICOS ga
on cp.GRADO_ID = ga.ID
where Empleado_ID = '204589123'