...
CONSTRAINT UQ_NOMBRE_GRADO UNIQUE (GRADO),
...
CONSTRAINT CHK_FECHA_INICIO_PERMISO CHECK(DATEDIFF(MONTH, FECHA_INICIO, FECHA_FIN) IN (6,12,24)),
CONSTRAINT CHK_FECHA_FIN_PERMISO CHECK(DATEDIFF(MONTH, FECHA_INICIO, FECHA_FIN) IN (6,12,24)),
...
CONSTRAINT CHK_MES_PLANILLA CHECK(MES >= 1 AND MES <= 12)
...
CONSTRAINT CHK_RENTA_TOTAL CHECK(RENTA_TOTAL >= 0),
